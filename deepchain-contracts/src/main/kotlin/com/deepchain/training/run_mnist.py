...
if __name__ == '__main__':
    ...
    for k in range(n_experiment):
        ...
        for i in range(worker_num):
            net1[i] = solver2_fun(
                net1[i],X_train[i],y_train[i],f1,val_set = val1_set,mb_size=mb_size,alpha=alpha,
                n_iter = n_iter,print_after = print_after
                )
        ...
        net2 = solver2_fun(
            net2,sample_train_x,sample_train_y,f2,val_set = val1_set,mb_size = mb_size,alpha = alpha,
            n_iter = n_iter,print_after = print_after
            )
